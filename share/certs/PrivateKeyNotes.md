...
unlocked to sign the Pfennig-Qt.app bundle.
...
allowing somebody to distribute a Pfennig-Qt.app or pfennig-qt-setup.exe with a valid
...
that the pfennig-qt.exe file inside the installer had not been tampered with.
