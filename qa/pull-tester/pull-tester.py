...
environ_default("CLONE_URL", "https://github.com/project-SWAPFORB/bitmark.git")
...
environ_default("BUILD_PATH", "/mnt/bitmark")
...
environ_default("GITHUB_REPO", "project-SWAPFORB/bitmark")
