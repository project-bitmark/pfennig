...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: P2PPORT or testnet: 1P2PPORT)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: RPCPORT or testnet: 1RPCPORT)") + "\n";
