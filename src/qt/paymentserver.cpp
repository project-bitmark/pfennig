...
const QString BITMARK_IPC_PREFIX("pfennig:");
const char* BITMARK_REQUEST_MIMETYPE = "application/pfennig-paymentrequest";
const char* BITMARK_PAYMENTACK_MIMETYPE = "application/pfennig-paymentack";
const char* BITMARK_PAYMENTACK_CONTENTTYPE = "application/pfennig-payment";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start pfennig: click-to-pay handler"));
        }
        else {
